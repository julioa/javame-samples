...
public class HelloMIDlet extends MIDlet implements CommandListener {
     ...
     */
    public HelloMIDlet() {
        cmd =new Command("Aceptar",Command.SCREEN,1);
    }
...
//GEN-LINE:|4-resumeMIDlet|1|4-postAction
    ...
    public void startApp() {
        ...
        Creador=new CMapas(165,170);
         //elForm=Creador.vista();prueba
         elForm.addCommand(cmd);
         elForm.setCommandListener((CommandListener)this);
         mDisplay = Display.getDisplay(this);
         mDisplay.setCurrent(elForm);
